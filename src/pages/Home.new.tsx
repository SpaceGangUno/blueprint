...
import StickyCarouselNav from '../components/StickyCarouselNav';
...
export default function Home() {
  ...
  return (
    <div className="pt-16 overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[100vh] sm:min-h-[500px] md:h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-0">
          <div className="space-y-5 md:space-y-6 max-w-3xl scroll-animate fade-up">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B00] to-[#FFEC00] ml-2 block md:inline gradient-flow">
                Long Lines
              </span>
            </h1>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="inline-block px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-[#FF6B00] to-[#E05A00] text-white font-bold rounded-lg transition-all duration-300 shadow-lg hover:shadow-[#FF6B00]/30 hover:-translate-y-1 active:translate-y-0 transform-gpu pulse-effect"
              >
      ...
      <section className="py-12 sm:py-20 bg-black text-white relative">
        {/* Futuristic grid overlay */}
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-10"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="scroll-animate fade-up">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-center text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-gray-300 gradient-flow">Streetwear Stores Struggle With:</h2>
            <p className="text-gray-400 text-center mb-8 sm:mb-12 max-w-2xl mx-auto">We'll tell you which pieces to burn 🔥 and which will sell out in 10 minutes.</p>
          </div>
          
          {/* Challenges Carousel Navigation */}
          <StickyCarouselNav
            activeIndex={activeChallengeIndex}
            totalItems={3}
            onPrev={() => handleChallengeSwipe('right')}
            onNext={() => handleChallengeSwipe('left')}
            onSelect={setActiveChallengeIndex}
            carouselName="challenge"
          />
      ...
      {/* Portfolio Section */}
      <section className="py-12 sm:py-20 bg-gradient-to-b from-black to-[#1E0B2C] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="scroll-animate fade-up">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-center text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-gray-300 gradient-flow">Featured Projects</h2>
            <p className="text-gray-400 text-center mb-8 sm:mb-12 max-w-2xl mx-auto">Check out some of our recent work for streetwear brands and retailers</p>
          </div>
          ...
          <StickyCarouselNav
            ...
            totalItems={3}
            onPrev={() => handlePortfolioSwipe('right')}
            onNext={() => handlePortfolioSwipe('left')}
            onSelect={setActivePortfolioIndex}
            carouselName="portfolio"
          />
