  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 px-6">
      <div className="max-w-lg mx-auto text-center">
        {/* Logo and Tagline */}
        <div className="mb-8">
          <h2 className="text-white text-2xl mb-3">Blueprint Studios</h2>
        ...
        {/* Quick Links */}
        <div className="mb-8">
          <h3 className="text-white text-xl font-normal mb-4">Quick Links</h3>
        ...
        {/* Contact */}
        <div className="mb-8">
          <h3 className="text-white text-xl font-normal mb-4">Contact</h3>
        ...
        {/* Follow Us */}
        <div className="mb-6">
          <h3 className="text-white text-xl font-normal mb-4">Follow Us</h3>
