          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              >
                ...
                <span className="font-semibold text-xl text-gray-900">Blueprint Studios</span>
              </Link>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="px-2 py-4 space-y-1 overflow-y-auto max-h-[calc(100vh-4rem)]">
              <Link
                to="/services"
                className="block w-full text-left px-4 py-3 text-lg text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors"
              >
                Services
              </Link>
              <Link
