  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-16 px-6">
      <div className="max-w-xl mx-auto text-center">
        {/* Logo and Tagline */}
        <div className="mb-16">
          <h2 className="text-white text-4xl mb-6">Blueprint Studios</h2>
        ...
        {/* Contact */}
        <div className="mb-16">
          <h3 className="text-white text-3xl font-normal mb-8">Contact</h3>
        ...
        {/* Follow Us */}
        <div>
          <h3 className="text-white text-3xl font-normal mb-8">Follow Us</h3>
